...
<body>
    ...
    <?php
            ...
            if(isset($_POST['submit'])) {
                $_SESSION['bgcolor'] = $_POST['bg-color'];
            }

            if(isset($_SESSION['bgcolor'])) {
                echo "<table style='background-color:".$_SESSION['bgcolor'].";'>";
            } else {
                echo "<table>";
            }
            ?>
            ...
            <form method="post" action="">
                ...
                <input type="color" id="bg-color" name="bg-color" value="
                <?php echo isset($_SESSION['bgcolor']) ? $_SESSION['bgcolor'] : '#ffffff'; ?>">
